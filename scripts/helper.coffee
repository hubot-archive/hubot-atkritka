...
exports.getImage = (tag, rndPage, callback) ->
  url = ""
  jsdom.env(
    ...
    ["http://code.jquery.com/jquery.js"], (errors, window) ->
      ...
      url = window.$("body > div.wrapper > div.content > div img")[exports.randInt(0, imgCount - 1)].src
      window.close()
      callback(url));

exports.getPageCount = (tag, callback) ->
  pageCount = 0
  jsdom.env(
...
exports.unicodeToWin1251_UrlEncoded = (s) ->
  L = []
  i = 0

  while i < s.length
    ord = s.charCodeAt(i)
    throw "Character " + s.charAt(i) + " isn't supported by win1251!"  unless ord of DMap
